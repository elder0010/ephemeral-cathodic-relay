...
java -jar %KICKASS% src/data/img_01.asm -o src/data/img01.prg -vicesymbols
java -jar %KICKASS% src/data/img_02.asm -o src/data/img02.prg -vicesymbols
java -jar %KICKASS% src/data/img_03.asm -o src/data/img03.prg -vicesymbols
java -jar %KICKASS% src/data/img_04.asm -o src/data/img04.prg -vicesymbols
java -jar %KICKASS% src/data/img_05.asm -o src/data/img05.prg -vicesymbols
java -jar %KICKASS% src/data/img_06.asm -o src/data/img06.prg -vicesymbols
